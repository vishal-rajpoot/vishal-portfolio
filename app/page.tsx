      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between dark:text-white">
            <h1 className="font-burtons text-xl">developedbyvishal</h1>
            <ul className="flex items-center">
              ...
              <li>
                <a
                  ...
                  href="https://drive.google.com/file/d/15UTEptEUIIlzgwjLoedV8gnes6iskGN3/view?usp=sharing"
                >
                  Resume
                </a>
              </li>
          ...
          <div className="text-center p-10 py-10">
            ...
            <a href="https://www.linkedin.com/in/vishal-rajput-275408160/">
              <AiFillLinkedin />
            </a>
            <a href="https://github.com/vishal-rajpoot">
              <AiFillGithub />
            </a>
            </div>
        ...
        <section>
          ...
          <div className="lg:flex gap-10">
            <div className="text-center shadow-lg p-10 rounded-xl my-10  dark:bg-white flex-1">
              ...
              <h4 className="py-4 text-teal-600">Frontend Technologies</h4>
              <p className="text-gray-800 py-1">HTML & CSS</p>
              <p className="text-gray-800 py-1">JavaScript</p>
              <p className="text-gray-800 py-1">React.js</p>
              <p className="text-gray-800 py-1">Next.js</p>
              <p className="text-gray-800 py-1">MaterialUI</p>
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1">
              ...
              <p className="text-gray-800 py-1">MariaDB</p>
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1">
              ...
              <h4 className="py-4 text-teal-600">Tools & PaaS Services</h4>
        ...
        <footer className="dark:bg-gray-900 bg-white text-gray-800 dark:text-gray-200 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h2 className="text-2xl py-2 dark:text-white md:text-3xl">Get in Touch</h2>
            <p className="mt-4">
              For inquiries, email me at{" "}
              <a href="mailto:vishalrajpoot540@gmail.com" className="text-teal-500 hover:underline">
                vishalrajpoot540@gmail.com
              </a>{" "}
              or call{" "}
              <a href="tel:+91 (979)-7955998" className="text-teal-500 hover:underline">
                +91 (979) 795-5998
              </a>
              .
            </p>
